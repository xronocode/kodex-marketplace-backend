...
PURPOSE: Define Kodex-wide GRACE engineering protocol and artifact governance.
SCOPE: Documentation rules, semantic markup, logging conventions, and verification discipline.
DEPENDS: docs/knowledge-graph.xml, docs/development-plan.xml, docs/verification-plan.xml
LINKS: M-GOVERNANCE, V-M-GOVERNANCE
END_MODULE_CONTRACT
START_MODULE_MAP
grace-framework-protocol - Core engineering constitution for all Kodex phases
semantic-markup-reference - Required module, function, and block anchors
logging-and-trace-convention - Stable observability and evidence format
verification-conventions - Cross-project testing and review expectations
END_MODULE_MAP
-->
# GRACE Framework - Project Engineering Protocol

## Keywords
marketplace, fastapi, vue3, postgresql, minio, async, fsd, docker-compose, agentic-commerce, multi-merchant, rbac, llms-txt, ai-only-dev, grace

## Annotation
Multi-merchant marketplace platform with Agentic Commerce layer. Phase 1 = prototype (ТЗ). Built AI-only via GRACE methodology.
